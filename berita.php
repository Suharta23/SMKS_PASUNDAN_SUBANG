        ...
        <div class="hero-2">
            <div class="container-fluid hero-2-fl">
                <div class="container d-flex align-items-center justify-content-center h-100 flex-column">
                    <h1 class="display-4 fw-bold hero-title" data-aos="fade-up" data-aos-delay="100">Berita & <span class="teg">Pengumuman</span></h1>
                    <p class="lead text-center" data-aos="fade-up" data-aos-delay="200">Dapatkan informasi terbaru mengenai kegiatan dan prestasi SMKS Pasundan Subang.</p>
                </div>
            </div>
        </div>
    </section>
                        ...
                        <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="300">
                            <div class="card h-100 shadow-sm rd-10 border-0 p-3">
                                ...
                                <div class="card-body p-3">
                                    ...
                                    <a href="detail_berita.php?id=1" class="btn btn-second btn-sm mt-2">Baca Selengkapnya</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="400">
                            <div class="card h-100 shadow-sm rd-10 border-0 p-3">
                                ...
                                <div class="card-body p-3">
                                    ...
                                    <a href="detail_berita.php?id=2" class="btn btn-second btn-sm mt-2">Baca Selengkapnya</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="500">
                            <div class="card h-100 shadow-sm rd-10 border-0 p-3">
                                ...
                                <div class="card-body p-3">
                                    ...
                                    <a href="detail_berita.php?id=3" class="btn btn-second btn-sm mt-2">Baca Selengkapnya</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="600">
                            <div class="card h-100 shadow-sm rd-10 border-0 p-3">
                                ...
                                <div class="card-body p-3">
                                    ...
                                    <a href="detail_berita.php?id=4" class="btn btn-second btn-sm mt-2">Baca Selengkapnya</a>
                                </div>
                            </div>
                        </div>
    ...
    <section class="py-5 bg-main text-center" data-aos="fade-up">
        <div class="container py-4">
            <div class="col-lg-9 mx-auto">
                ...
                <a href="artikel.php" class="btn btn-lig btn-lg px-5 py-3" data-aos="zoom-in" data-aos-delay="300">
