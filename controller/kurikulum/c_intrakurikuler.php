<?php
    ...
    $judul_hero2="Intrakurikuler";

    $subjudul_hero="Pembelajaran inti terstruktur untuk mencapai kompetensi akademik dan vokasi siswa.";
    ...
    $teks_awal= '<strong>Ekstrakurikuler</strong> memberikan kesempatan bagi siswa untuk memperdalam minat dan bakatnya di luar jam pelajaran.';
