        ...
        <div class="container py-4">
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-7" data-aos="fade-left">
                    ...
                    <a href="/profil/sambutan" class="btn btn-main btn-lg px-5 py-3 mt-2">Baca Sambutan Selengkapnya <i class="bi bi-arrow-right-short text-white"></i></a>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row g-4 justify-content-center">
                ...
                <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="200">
                    <div class="card shadow-sm h-100 p-4 text-center program-card rd-20 txt-dark">
                        ...
                        <!-- gunakan routing internal -->
                        <a href="/kesiswaan/ngabar" class="btn btn-second btn-sm mt-2">Lihat Detail</a>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="300">
                    <div class="card shadow-sm h-100 p-4 text-center program-card rd-20 txt-dark">
                        ...
                        <a href="/kesiswaan/mbg" class="btn btn-second btn-sm mt-2">Lihat Detail</a>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="400">
                    <div class="card shadow-sm h-100 p-4 text-center program-card rd-20 txt-dark">
                        ...
                        <a href="/kesiswaan/k7" class="btn btn-second btn-sm mt-2">Lihat Detail</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-4 col-md-6" data-aos="zoom-in-up">
                    <div class="card shadow h-100 border-0 rd-20 p-3 txt-dark">
                        ...
                        <div class="card-body p-4">
                            ...
                            <a href="/jurusan/rpl" class="btn btn-main">Lihat Detail <i class="bi bi-arrow-right-short text-white"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6" data-aos="zoom-in-up" data-aos-delay="100">
                    <div class="card shadow h-100 border-0 rd-20 p-3 txt-dark">
                        ...
                        <div class="card-body p-4">
                            ...
                            <a href="/jurusan/tkj" class="btn btn-main">Lihat Detail <i class="bi bi-arrow-right-short text-white"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6" data-aos="zoom-in-up" data-aos-delay="200">
                    <div class="card shadow h-100 border-0 rd-20 p-3 txt-dark">
                        ...
                        <div class="card-body p-4">
                            ...
                            <a href="/jurusan/tkr" class="btn btn-main">Lihat Detail <i class="bi bi-arrow-right-short text-white"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6" data-aos="zoom-in-up">
                    <div class="card shadow h-100 border-0 rd-20 p-3 txt-dark">
                        ...
                        <div class="card-body p-4">
                            ...
                            <a href="/jurusan/akuntansi" class="btn btn-main">Lihat Detail <i class="bi bi-arrow-right-short text-white"></i></a>
                        </div>
                    </div>
                </div>

                <div class="col-lg-4 col-md-6" data-aos="zoom-in-up" data-aos="100">
                    <div class="card shadow h-100 border-0 rd-20 p-3 txt-dark">
                        ...
                        <div class="card-body p-4">
                            ...
                            <a href="/jurusan/perkantoran" class="btn btn-main">Lihat Detail <i class="bi bi-arrow-right-short text-white"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6" data-aos="zoom-in-up" data-aos-delay="200">
                    <div class="card shadow h-100 border-0 rd-20 p-3 txt-dark">
                        ...
                        <div class="card-body p-4">
                            ...
                            <a href="/jurusan/perhotelan" class="btn btn-main">Lihat Detail <i class="bi bi-arrow-right-short text-white"></i></a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="py-5 bg-light">
        <div class="container">
            ...
            <div class="text-center mt-5">
                <a href="/hubinmas/mitra_dudi" class="btn btn-main btn-lg px-5 py-3" data-aos="zoom-in" data-aos-delay="400">
                ...
                <div class="col-md-4" data-aos="fade-up" data-aos-delay="400">
                    <div class="card shadow h-100 border-0 rd-20 p-3 txt-dark">
                        ...
                        <div class="card-body p-4">
                            ...
                            <a href="/informasi/artikel" class="btn btn-main">Baca Selengkapnya <i class="bi bi-arrow-right-short text-white"></i></a>
                        </div>
                    </div>
                </div>
