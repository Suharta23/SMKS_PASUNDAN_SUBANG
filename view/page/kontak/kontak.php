        ...
        <div class="container py-4">
            <div class="col-lg-9 mx-auto">
                ...
                <div data-aos="zoom-in" data-aos-delay="300">
                    <a href="#" class="text-decoration-none fs-1 me-4"><i class="bi bi-instagram text-white "></i></a>
                    <a href="#" class="text-decoration-none fs-1 me-4"><i class="bi bi-facebook text-white "></i></a>
                    <a href="#" class="text-decoration-none fs-1 me-4"><i class="bi bi-youtube text-white "></i></a>
                    <a href="#" class="text-decoration-none fs-1"><i class="bi bi-whatsapp text-white "></i></a>
                </div>
            </div>
        </div>
    </section>
